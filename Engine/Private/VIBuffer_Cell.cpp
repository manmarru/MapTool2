...
#pragma region VERTEX_BUFFER
	...
	memcpy(pVertices, _pPoints, sizeof(VTXPOS) * m_iNumVertices);
...
CVIBuffer_Cell* CVIBuffer_Cell::Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext, const _float3* pPoints)
{
